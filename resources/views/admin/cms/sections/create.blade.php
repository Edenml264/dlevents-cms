...
<div class="space-y-6">
    <div class="bg-white shadow rounded-lg">
        <form action="{{ route('admin.cms.sections.store') }}" method="POST" class="p-6">
            @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="identifier" class="block text-sm font-medium text-gray-700">
                                Identificador
                                <span class="text-xs text-gray-500">(dejar en blanco para generar automáticamente)</span>
                            </label>
                    ...
                    <div id="content-editor">
                        <div class="text-content">
                            ...
                            <textarea name="content" id="content" rows="10"
                                class="tinymce-editor mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('content') border-red-500 @enderror">{{ old('content') }}</textarea>
                            @error('content')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="media-content hidden">
